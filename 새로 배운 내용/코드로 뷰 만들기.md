...
static let 으로 계속 혹은 자주 사용할거 같은 색상을 정해둬서 쓰면 간편함
...
## NSAttributedString 으로 텍스트 비주얼 스타일, 하이퍼링크 또는 접근성 데이터 만들기
...
```swift
        ...
        let stack = UIStackView(arrangedSubviews: [emailContrainerView, fullnameContrainerView ,passwordContrainerView])
        stack.axis = .vertical
